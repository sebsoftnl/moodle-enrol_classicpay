...
$string['privacy:metadata:enrol_classicpay:orderid'] = 'Uniek identificatienummer voor de betaling.';
$string['privacy:metadata:enrol_classicpay:status'] = 'Een nummer dat intern gebruikt wordt om de betalingsstatus aan te duiden.';
$string['privacy:metadata:enrol_classicpay:statusname'] = 'De betalingsstatus die overeen komt met het statusnummer.';
$string['privacy:metadata:enrol_classicpay:gateway_transaction_id'] = 'Het nummer dat wordt gebruikt voor de betaling via PayNL\'s portaal.';
$string['privacy:metadata:enrol_classicpay:gateway'] = 'Het portaal dat gebruikt is voor de betaling. PayNL of Moodle als de cursus gratis is.';
$string['privacy:metadata:enrol_classicpay:rawcost'] = 'De cursus kosten voordat kortingen zijn toegepast.';
$string['privacy:metadata:enrol_classicpay:cost'] = 'De cursus kosten nadat kortingen zijn toegepast.';
$string['privacy:metadata:enrol_classicpay:percentage'] = 'Kortingspercentage.';
$string['privacy:metadata:enrol_classicpay:discount'] = 'Hoeveelheid korting.';
$string['privacy:metadata:enrol_classicpay:hasinvoice'] = 'De primaire database sleutel om te controleren of een invoice voor deze betaling bestaat, de volledige betaling is te bekijken op het Sebsoft klantenportaal.';
$string['privacy:metadata:enrol_classicpay:timecreated'] = 'Tijdstip waarop de betaling is aangemaakt.';
$string['privacy:metadata:enrol_classicpay:timemodified'] = 'Tijdstip waarop de betaling is gewijzigd.';