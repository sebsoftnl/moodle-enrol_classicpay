...
$string['privacy:metadata:enrol_classicpay:orderid'] = 'Unique identification code for the payment order.';
$string['privacy:metadata:enrol_classicpay:status'] = 'Integer which is used internally to check the status of the payment.';
$string['privacy:metadata:enrol_classicpay:statusname'] = 'Status of the payment which corresponds with the status integer.';
$string['privacy:metadata:enrol_classicpay:gateway_transaction_id'] = 'The integer used for the payment through Pay\'s gateway.';
$string['privacy:metadata:enrol_classicpay:gateway'] = 'The gateway which was used for the payment. Either PayNL or Moodle if the enrolment was for free.';
$string['privacy:metadata:enrol_classicpay:rawcost'] = 'The cost of the payment before any discount is applied.';
$string['privacy:metadata:enrol_classicpay:cost'] = 'The cost of the payment after any discount is applied.';
$string['privacy:metadata:enrol_classicpay:percentage'] = 'If a coupon with a percentage based discount was used, this shows the applied percentage.';
$string['privacy:metadata:enrol_classicpay:discount'] = 'The discount in absolute numbers that is applied to the payment.';
$string['privacy:metadata:enrol_classicpay:hasinvoice'] = 'The primary database key to check whether an invoice exists for this payment, the Sebsoft customer panel has the actual invoice.';
$string['privacy:metadata:enrol_classicpay:timecreated'] = 'Time at which the payment was started.';
$string['privacy:metadata:enrol_classicpay:timemodified'] = 'Time at which the payment was modified.';